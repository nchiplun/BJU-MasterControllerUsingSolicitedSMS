...
nxtVlv: if (!valveDue && !phaseFailureDetected && !lowPhaseCurrentDetected) {
        ...
        if (valveDue && dueValveChecked) {
            ...
            if (fieldList[0]<9){
                ...
                temporaryBytesArray[1] = fieldList[0] + 49;
            }
            else if (fieldList[0] > 8 && fieldList[0] < 12) {
                temporaryBytesArray[0] = 49;
                temporaryBytesArray[1] = fieldList[0] + 39;
            }
            sendSms(SmsKey2, userMobileNo, 2);

            actionsOnDueValve(fieldList[0]);
...
# 408 "main_1Test.c"
        ...
        if (onHold) {
            ...
            sendSms(SmsKey1, userMobileNo, 0);
...
# 427 "main_1Test.c"
            if (newSMSRcvd) {
                ...
                strncpy((char*)(decodedString),(char*)("HOLD01"),(6));
