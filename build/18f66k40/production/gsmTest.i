...
void sendSms(const char *message, unsigned char phoneNumber[], unsigned char info) {
    ...
    case 7:
        transmitNumberToGSM(temporaryBytesArray, 2);
        myMsDelay(10);
        if (fieldValve[fieldList[iterator]].isConfigured) {
            transmitStringToGSM(" ON:");
            myMsDelay(10);
            lower8bits = fieldValve[fieldList[iterator]].onPeriod;
            ...
            myMsDelay(10);
            transmitStringToGSM(" OFF:");
            myMsDelay(10);
            temporaryBytesArray[0] = (fieldValve[fieldList[iterator]].offPeriod/10) + 48;
            temporaryBytesArray[1] = (fieldValve[fieldList[iterator]].offPeriod%10) + 48;
            transmitNumberToGSM(temporaryBytesArray,2);
            myMsDelay(10);
            transmitStringToGSM(" Dry:");
            myMsDelay(10);
            lower8bits = fieldValve[fieldList[iterator]].dryValue;
            temporaryBytesArray[0] = (unsigned char) ((lower8bits / 100) + 48);
            temporaryBytesArray[1] = (unsigned char) (((lower8bits % 100) / 10) + 48);
            temporaryBytesArray[2] = (unsigned char) ((lower8bits % 10) + 48);
            transmitNumberToGSM(temporaryBytesArray,3);
            ...
            myMsDelay(10);
            lower8bits = fieldValve[fieldList[iterator]].wetValue;
            temporaryBytesArray[0] = (unsigned char) ((lower8bits / 100) + 48);
            temporaryBytesArray[1] = (unsigned char) (((lower8bits % 100) / 10) + 48);
            temporaryBytesArray[2] = (unsigned char) ((lower8bits % 10) + 48);
            transmitNumberToGSM(temporaryBytesArray,3);
            myMsDelay(10);
            transmitStringToGSM(" DD: ");
            myMsDelay(10);
            temporaryBytesArray[0] = (fieldValve[fieldList[iterator]].nextDueDD/10) + 48;
            temporaryBytesArray[1] = (fieldValve[fieldList[iterator]].nextDueDD%10) + 48;
            transmitNumberToGSM(temporaryBytesArray,2);
            myMsDelay(10);
            temporaryBytesArray[0] = (fieldValve[fieldList[iterator]].nextDueMM/10) + 48;
            temporaryBytesArray[1] = (fieldValve[fieldList[iterator]].nextDueMM%10) + 48;
            transmitNumberToGSM(temporaryBytesArray,2);
            myMsDelay(10);
            temporaryBytesArray[0] = (fieldValve[fieldList[iterator]].nextDueYY/10) + 48;
            temporaryBytesArray[1] = (fieldValve[fieldList[iterator]].nextDueYY%10) + 48;
            transmitNumberToGSM(temporaryBytesArray,2);
            myMsDelay(10);
            temporaryBytesArray[0] = (fieldValve[fieldList[iterator]].motorOnTimeHour/10) + 48;
            temporaryBytesArray[1] = (fieldValve[fieldList[iterator]].motorOnTimeHour%10) + 48;
            transmitNumberToGSM(temporaryBytesArray,2);
            myMsDelay(10);
            temporaryBytesArray[0] = (fieldValve[fieldList[iterator]].motorOnTimeMinute/10) + 48;
            temporaryBytesArray[1] = (fieldValve[fieldList[iterator]].motorOnTimeMinute%10) + 48;
            transmitNumberToGSM(temporaryBytesArray,2);
            myMsDelay(10);
            transmitStringToGSM("\r\n");
            if (fieldValve[fieldList[iterator]].isFertigationEnabled) {
                transmitStringToGSM("Fertigation enabled with delay:");
                lower8bits = fieldValve[fieldList[iterator]].fertigationDelay;
                temporaryBytesArray[0] = (unsigned char) ((lower8bits / 100) + 48);
                temporaryBytesArray[1] = (unsigned char) (((lower8bits % 100) / 10) + 48);
                temporaryBytesArray[2] = (unsigned char) ((lower8bits % 10) + 48);
                transmitNumberToGSM(temporaryBytesArray,3);
                ...
                transmitStringToGSM(" ON:");
                myMsDelay(10);
                lower8bits = fieldValve[fieldList[iterator]].fertigationONperiod;
                temporaryBytesArray[0] = (unsigned char) ((lower8bits / 100) + 48);
                temporaryBytesArray[1] = (unsigned char) (((lower8bits % 100) / 10) + 48);
                temporaryBytesArray[2] = (unsigned char) ((lower8bits % 10) + 48);
                transmitNumberToGSM(temporaryBytesArray,3);
                myMsDelay(10);
                transmitStringToGSM(" Itrn:");
                myMsDelay(10);
                temporaryBytesArray[0] = (fieldValve[fieldList[iterator]].fertigationInstance/10) + 48;
                temporaryBytesArray[1] = (fieldValve[fieldList[iterator]].fertigationInstance%10) + 48;
                transmitNumberToGSM(temporaryBytesArray,2);
                myMsDelay(10);
                transmitStringToGSM(" Inj1: ");
                myMsDelay(10);
                temporaryBytesArray[0] = (fieldValve[fieldList[iterator]].injector1OnPeriod%10) + 48;
                transmitNumberToGSM(temporaryBytesArray,1);
                myMsDelay(10);
                temporaryBytesArray[0] = (fieldValve[fieldList[iterator]].injector1OffPeriod%10) + 48;
                transmitNumberToGSM(temporaryBytesArray,1);
                myMsDelay(10);
                temporaryBytesArray[0] = (fieldValve[fieldList[iterator]].injector1Cycle%10) + 48;
                transmitNumberToGSM(temporaryBytesArray,1);
                myMsDelay(10);
                transmitStringToGSM(" Inj2: ");
                myMsDelay(10);
                temporaryBytesArray[0] = (fieldValve[fieldList[iterator]].injector2OnPeriod%10) + 48;
                transmitNumberToGSM(temporaryBytesArray,1);
                myMsDelay(10);
                temporaryBytesArray[0] = (fieldValve[fieldList[iterator]].injector2OffPeriod%10) + 48;
                transmitNumberToGSM(temporaryBytesArray,1);
                myMsDelay(10);
                temporaryBytesArray[0] = (fieldValve[fieldList[iterator]].injector2Cycle%10) + 48;
                transmitNumberToGSM(temporaryBytesArray,1);
                myMsDelay(10);
                transmitStringToGSM(" Inj3: ");
                myMsDelay(10);
                temporaryBytesArray[0] = (fieldValve[fieldList[iterator]].injector3OnPeriod%10) + 48;
                transmitNumberToGSM(temporaryBytesArray,1);
                myMsDelay(10);
                temporaryBytesArray[0] = (fieldValve[fieldList[iterator]].injector3OffPeriod%10) + 48;
                transmitNumberToGSM(temporaryBytesArray,1);
                myMsDelay(10);
                temporaryBytesArray[0] = (fieldValve[fieldList[iterator]].injector3Cycle%10) + 48;
                transmitNumberToGSM(temporaryBytesArray,1);
                myMsDelay(10);
                transmitStringToGSM(" Inj4: ");
                myMsDelay(10);
                temporaryBytesArray[0] = (fieldValve[fieldList[iterator]].injector4OnPeriod%10) + 48;
                transmitNumberToGSM(temporaryBytesArray,1);
                myMsDelay(10);
                temporaryBytesArray[0] = (fieldValve[fieldList[iterator]].injector4OffPeriod%10) + 48;
                transmitNumberToGSM(temporaryBytesArray,1);
                myMsDelay(10);
                temporaryBytesArray[0] = (fieldValve[fieldList[iterator]].injector4Cycle%10) + 48;
                transmitNumberToGSM(temporaryBytesArray,1);
                myMsDelay(10);
                transmitStringToGSM("\r\n");
            }
            ...
            transmitStringToGSM(" not configured\r\n");
            myMsDelay(10);
        }
        break;
    case 8:
