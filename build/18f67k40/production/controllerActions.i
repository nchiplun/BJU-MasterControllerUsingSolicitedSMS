...
# 3178 "controllerActions.c"
    if(moistureSensorFailed) {
        moistureSensorFailed = 0;

        sendSms(SmsMS1, userMobileNo, 2);
# 3190 "controllerActions.c"
    }
    else {
...
# 3310 "controllerActions.c"
}
# 3322 "controllerActions.c"
void deepSleep(void) {
